...
public class EncryptionUtil {
    ...
    /**
     * 加密
     * @param kg 加密算法 AES RSA
     * @param txt 要加密内容
     * @param kgKey 加密密钥
     */
    public static String encrypt(String kg,String txt,String kgKey)throws Exception{
        return switch (kg) {
            case "AES" -> encryptWithAES(txt, kgKey);
            case "RSA" -> encryptWithRSA(txt, new PublicKey() {//todo
                @Override
            ...
            default -> throw new Exception("不支持的加密算法");
        };
    }

    public static String decryp(String kg,String txt,String kgKey) throws Exception {
        return switch (kg) {
            case "AES" -> decryptWithAES(txt, kgKey);
            case "RSA" -> decryptWithRSA(txt, new PrivateKey() {//todo
                @Override
                public String getAlgorithm() {
                    return null;
                }
    ...
    public static void main(String[] args) throws Exception {
        String txt = "1726991748775";
        String pas = "2024-09-22_22-90-4202";
        String s = encryptWithAES(txt, pas);
        System.out.println(s);

        String s1 = decryptWithAES(s, pas);
